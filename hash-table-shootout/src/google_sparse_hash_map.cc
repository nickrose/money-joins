...
typedef google::sparse_hash_map<KeyType, ValueType, Hasher> hash_t;
typedef google::sparse_hash_map<std::string, int64_t, StringHasher> str_hash_t;

#define SETUP hash_t hash; hash.set_deleted_key(-1); str_hash_t str_hash; str_hash.set_deleted_key("");
