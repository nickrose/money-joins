...
typedef tsl::robin_map<KeyType, ValueType, Hasher> hash_t;
typedef tsl::robin_map<std::string, int64_t, StringHasher> str_hash_t;

#define SETUP hash_t hash; hash.max_load_factor(0.99f); str_hash_t str_hash; str_hash.max_load_factor(0.99f);
