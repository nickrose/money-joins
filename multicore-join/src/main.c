...
#include "pmoney_join_2.h"
#include "pmoney_join_3.h"
...
static inline int64_t Noop(relation_t *relR, relation_t *relS, int nthreads) {}
...
parse_args(int argc, char ** argv, param_t * cmd_params) 
{
    ...
    while(1) {
        ...
        c = getopt_long (argc, argv, "a:n:t:p:r:s:o:x:y:z:hv",
